          ...
          <?php require_once "blocks/panel.php"?>
           <div id="leftCol">
               ...
               <?php
                    ...
                    if(!isset($_GET['type'])) {
                        echo '<div id="main">Современный бодибилдинг уже давно превратился в большой бизнес, поэтому львиная доля статей, книг, курсов, методик ориентирована на получение прибыли и не приносит реальной пользы спортсменам, особенно тем, которые еще не нашли свой собственный путь…
...
<br><p>Задумайтесь, что лучше:<br>
    ...
    <br>Завидовать чужим результатам либо же добиться успеха самому?</p>
<p><br>Портал «Workout» - не просто сайт о бодибилдинге, он призван стать проводником в океане информации. На страницах данного портала бодибилдинг позиционируется не просто как вид спорта, а как наука. Такой подход предоставит ответы на все интересующие Вас вопросы.
